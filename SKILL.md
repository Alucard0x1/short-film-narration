...
- **Sound design**: every scene carries at least one `SFX/MUSIK:` cue line — sound is part of the script, and scenes without dialogue still need visual action + sound
